 ...
 */
package com.mayursatav.aem.orbit.core.models;
...
import com.mayursatav.aem.orbit.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "orbit/components/helloworld");
